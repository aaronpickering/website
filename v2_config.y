...
title                    : "Gracelands Farm"
title_separator          : "-"
subtitle                 : # site tagline that appears below site title in masthead
name                     : "Aaron Pickering"
description              : "A place to find new experiences."
...
author:
  ...
  bio              : "Father, Veteran and mental health advocate."
  location         : "Shannons Flat, NSW"
  email            :
  links:
    - label: "Email"
      icon: "fas fa-fw fa-envelope-square"
      # url: "mailto:say.hi@gracelands.farm"
    - label: "Website"
      icon: "fas fa-fw fa-link"
      # url: "https://web.gracelands.farm"
    - label: "Twitter"
